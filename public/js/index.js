(function () {
    ...
    g = function () {
        ...
        return h = $(".splash"), h.cropit({
            imageBackground: !0,
            imageState: {src: "http://scottcheng.github.io/cropit/images/0-1920.jpg"},
        ...
        return e = $(".demo-wrapper.basic"), e.cropit({
            imageState: {
                ...
                offset: {x: 0, y: -25}
            }, onZoomEnabled: d.bind(e), onZoomDisabled: c.bind(e), onImageError: b.bind(e.find(".cropit-preview"))
        ...
        return h = $(".demo-wrapper.custom-button"), h.cropit({
            imageState: {
                ...
                offset: {x: 0, y: -94}
            }, onZoomEnabled: d.bind(h), onZoomDisabled: c.bind(h), onImageError: b.bind(h.find(".cropit-preview"))
        }), h.on("click", ".rotate-cw-btn", g.bind(h)), h.on("click", ".rotate-ccw-btn", f.bind(h)), h.on("click", ".select-image-btn", e.bind(h)), h.on("click", ".download-btn", a.bind(h))
    }(), function () {
        var h;
        return h = $(".demo-wrapper.image-background"), h.cropit({
            imageBackground: !0,
            imageState: {src: "http://scottcheng.github.io/cropit/images/3-960.jpg", offset: {x: 0, y: -86}},
            onZoomEnabled: d.bind(h),
            onZoomDisabled: c.bind(h),
            onImageError: b.bind(h.find(".cropit-preview"))
        }), h.on("click", ".rotate-cw-btn", g.bind(h)), h.on("click", ".rotate-ccw-btn", f.bind(h)), h.on("click", ".select-image-btn", e.bind(h)), h.on("click", ".download-btn", a.bind(h))
        ...
        return h = $(".demo-wrapper.image-background-border"), h.cropit({
            ...
            imageState: {src: "http://scottcheng.github.io/cropit/images/4-960.jpg", offset: {x: 0, y: -154}},
            onZoomEnabled: d.bind(h),
            onZoomDisabled: c.bind(h),
            onImageError: b.bind(h.find(".cropit-preview"))
        }), h.on("click", ".rotate-cw-btn", g.bind(h)), h.on("click", ".rotate-ccw-btn", f.bind(h)), h.on("click", ".select-image-btn", e.bind(h)), h.on("click", ".download-btn", a.bind(h))
