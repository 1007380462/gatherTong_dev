...
@section('time-day-start')
    <div class="col-md-6">
        ...
        <div style="padding-left: 0px" class="col-md-3">
            <select id="start_year" name="start_year" class="form-control"></select>
        </div>
        ...
        <div class="col-md-3">
            <select id="start_day" name="start_day" class="form-control"></select>
        </div>
...
@section('time-day-end')
    <div class="col-md-6">
        ...
        <div style="padding-left: 0px" class="col-md-3">
            <select id="end_year" name="end_year" class="form-control"></select>
        </div>
        <div class="col-md-3">
            <select id="end_month" name="end_month" class="form-control"></select>
        </div>
        <div class="col-md-3">
            <select id="end_day" name="end_day" class="form-control"></select>
        </div>
...
@section('time-second')
    ...
    <div class="demo2">
        ...
        <div class="col-md-2">
            <input placeholder="请输入日期" namr="time" class="laydate-icon form-control"
