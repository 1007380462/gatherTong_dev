...
@section('content')
                    ...
                    <li style="margin-top: -20px; ">
                        <a title="" target="_blank" href="#">
                            <img width="1920" height="482" alt=""
                                 style="background: url(/img/carouselFigure/banner1.jpg) no-repeat center;"
                                 src=" {{URL::asset('/')}}img/carouselFigure/alpha.png">
                        </a>
                    </li>
                    <li style="margin-top: -20px; ">
                        <a title="" href="#">
                            <img width="1920" height="482" alt=""
                                 style="background: url(/img/carouselFigure/banner2.jpg) no-repeat center;"
                                 src=" {{URL::asset('/')}}img/carouselFigure/alpha.png">
                        </a>
                    </li>
                    <li style="margin-top: -20px; ">
                        <a title="" href="#">
                            <img width="1920" height="482" alt=""
                                 style="background: url(/img/carouselFigure/banner3.jpg) no-repeat center;"
                                 src=" {{URL::asset('/')}}img/carouselFigure/alpha.png">
                        </a>
                    </li>
                </ul>
    ...
    {{--用于发布按钮的连接设置--}}
    <script>
        function pullSponsor() {
            $('#releaseSponsor').attr('href', '/front/sponsor/pull-sponsor');
        }
        function provideSponsor() {
            $('#releaseSponsor').attr('href', '/front/sponsor/provide-sponsor');
        }
    </script>
@endsection